import { BatchHeader } from "./../../React-rpg/src/eigenda-connector/src/generated/disperser_pb.d";
...
export async function storeBlob(
  ...
  try {
    ...
    // };
    return {
      headerhash: statusResult.batchHeaderHash,
      blobindex: statusResult.blobIndex,
    };
  } catch (error) {
